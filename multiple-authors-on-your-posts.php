 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Multiple Authors On Your Posts
 * Plugin URI:        http://beentheresoft.com/
 * Description:       This plugin is Allows multiple authors to be assigned to a post.
 * Version:           1.0.0
 * Author:            Acquaintsoft
 * Author URI:        http://beentheresoft.com/
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       multiple-authors-on-your-postss
...
/*------------------Function Construct------------------------*/
	function __construct() {
		...
		register_activation_hook( __FILE__, 'pcauthor_activate_Multiple_Authors_On_Your_Posts' );
		register_deactivation_hook( __FILE__, 'pcauthor_deactivate_Multiple_Authors_On_Your_Posts' );

		/**
		 * The core plugin class that is used to define internationalization,
		 * admin-specific hooks, and public-facing site hooks.
		 */
		require plugin_dir_path( __FILE__ ) . 'includes/class-multiple-authors-on-your-postss.php';
 ...
 * This action is documented in includes/class-multiple-authors-on-your-postss-activator.php
 */
function pcauthor_activate_Multiple_Authors_On_Your_Posts() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-multiple-authors-on-your-postss-activator.php';
	Multiple_Authors_On_Your_Posts_Activator::pcauthor_activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-multiple-authors-on-your-postss-deactivator.php
 */
function pcauthor_deactivate_Multiple_Authors_On_Your_Posts() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-multiple-authors-on-your-postss-deactivator.php';
	Multiple_Authors_On_Your_Posts_Deactivator::pcauthor_deactivate();
}
 ...
 * @since    1.0.0
 */
function pcauthor_run_Multiple_Authors_On_Your_Posts() {

	$plugin = new Multiple_Authors_On_Your_Posts();
	$plugin->pcauthor_run();

}
pcauthor_run_Multiple_Authors_On_Your_Posts();